...
from src.TumorNetSolvers.reg_nnUnet.imageio.natural_image_reader_writer import NaturalImage2DIO
from src.TumorNetSolvers.reg_nnUnet.imageio.nibabel_reader_writer import NibabelIO, NibabelIOWithReorient
from src.TumorNetSolvers.reg_nnUnet.imageio.simpleitk_reader_writer import SimpleITKIO2
from src.TumorNetSolvers.reg_nnUnet.imageio.tif_reader_writer import Tiff3DIO
...
def recursive_find_reader_writer_by_name(rw_class_name: str) -> Type[BaseReaderWriter]:
    ret = recursive_find_python_class(join(src.TumorNetSolvers.reg_nnUnet.__path__[0], "imageio"), rw_class_name, 'reg_nnUnet.imageio')
    if ret is None:
